...
up:
	...
	@docker-compose up -d
	@echo "ft_transcendence is running at https://localhost:8443"
...
fclean: clean
	...
	@rm -rf database/transcendence.db database/*.db-* uploads/
	@docker rm -f ft_transcendence_backend ft_transcendence_frontend ft_transcendence_ssl 2>/dev/null || true
